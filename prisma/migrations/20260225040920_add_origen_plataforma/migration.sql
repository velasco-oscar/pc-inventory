...
INSERT INTO "new_Componente" ("capacidadUnidad", "capacidadValor", "categoriaId", "comprobanteCompra", "costoMxn", "costoOriginal", "createdAt", "ensambleId", "estado", "fechaCompra", "foto", "id", "marca", "modelo", "monedaCompra", "notas", "numeroSerie", "potenciaUnidad", "potenciaValor", "proveedorId", "socket", "tipoCambio", "updatedAt", "velocidadUnidad", "velocidadValor", "vramUnidad", "vramValor") SELECT "capacidadUnidad", "capacidadValor", "categoriaId", "comprobanteCompra", "costoMxn", "costoOriginal", "createdAt", "ensambleId", "estado", "fechaCompra", "foto", "id", "marca", "modelo", "monedaCompra", "notas", "numeroSerie", "potenciaUnidad", "potenciaValor", "proveedorId", "socket", "tipoCambio", "updatedAt", "velocidadUnidad", "velocidadValor", "vramUnidad", "vramValor" FROM "Componente";
